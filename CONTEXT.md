...
- **Demo user** — the seeded fictional user owning 90 days of seed entries, reachable via a "Try the demo" button on login. Never mixed with real entries (userId-scoped).
