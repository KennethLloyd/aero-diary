...
The demo seed owns the configured-demo activities. The post-v1 import owns creation and resolution of the private account's 25 legacy activities. There is no shared global activity vocabulary.
...
- The legacy import can be rerun without touching configured-demo data.
