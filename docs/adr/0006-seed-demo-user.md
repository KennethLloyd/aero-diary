...
- `prisma seed` creates:
  ...
  - **90 days of fictional entries** ending "today", covering all 5 moods (weighted like a real life: mostly Good/Rad, some Meh, rare Bad/Awful), ~8 seeded activities, a handful of stock photos (not Kenneth's).
